...
INTERSECTIONS = {
    ...
    'not_predicate_intersect_example': [  # Original test
        ObjectNotContainsSubset(value={'admin': StringEqualTo(value='true')}),  # Not admin user
    ...
    'obj_eq_val_int_eq_1_equiv_logical_int': [
        ...
        AndPredicate(
            predicates=[
                ...
                ObjectEqualTo(value={'num': ~IntegerLessThan(value=1)}),
            ]
        ),
    ],
    ...
    'obj_eq_val_range_1_lt_x_lt_5_equiv_logical_int_range': [  # Name from original
        ...
        AndPredicate(  # Object with 'field' >=1 AND 'field' <=5 AND 'field' != 1 AND 'field' != 5
            predicates=[
                ...
                ObjectEqualTo(value={'field': IntegerNotEqualTo(value=1)}),
                ObjectEqualTo(value={'field': IntegerNotEqualTo(value=5)}),
            ]
        ),
    ],
