...
class GenericDynamicKeyMatch(BaseModel, Generic[_t_SpecifiedType]):
...
class GenericObjectEqualTo(
    ...
    def __invert__(self):
        return GenericObjectNotEqualTo[self._get_generic_parameters()](
            value=self.value, dynamic_matches=self.dynamic_matches
        )
