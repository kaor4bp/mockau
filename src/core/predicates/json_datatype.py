...
class JsonDatatype:
    ...
    def __init__(self, level: int = 0, prefix: str = 'json_var') -> None:
    ...
    @classmethod
    def _build_json_type(cls, level: int = 0):
        ...
        if level < cls.MAX_NESTING_LEVEL:
            ...
            json_datatype.declare(
                ...
                # ('get_object_keys', z3.SeqSort(z3.StringSort())),
            )
            # json_datatype.declare(
            #     'object',
            #     ('get_object', z3.ArraySort(z3.StringSort(), json_datatype)),
            #     # ('get_object_keys', z3.SeqSort(z3.StringSort())),
            # )
        ...
        cls._Z3_JSON_DATATYPES[level] = json_datatype_sort
    ...
    #         json_datatype.declare(
    #             'object',
    #             ('get_object', z3.ArraySort(z3.StringSort(), json_datatype_sort)),
    #             # ('get_object_keys', z3.SeqSort(z3.StringSort())),
    #         )
    #         # json_datatype.declare(
    #         #     'object',
    ...
    #
    #
    #         json_list = z3.SeqSort(json_datatype_sort)
    #         json_datatype.declare(
    #             'array',
    #             ('get_array', json_list),
    #         )
    #
    #     json_datatype_sort = json_datatype.create()
    #     for i in range(cls.MAX_NESTING_LEVEL):
    #         cls._Z3_JSON_DATATYPES[i] = json_datatype_sort
    #     return json_datatype_sort
    ...
    def get_object_keys(self):
        return self.JsonType.get_object_keys(self._var)
