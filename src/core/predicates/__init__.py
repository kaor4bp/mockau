...
class GenericNestedAnyOf(NestedAnyOf, Generic[_t_SpecifiedType]):
    predicate: _t_SpecifiedType


class GenericNestedAllOf(NestedAllOf, Generic[_t_SpecifiedType]):
    predicate: _t_SpecifiedType


class GenericNestedNoneOf(NestedNoneOf, Generic[_t_SpecifiedType]):
    predicate: _t_SpecifiedType
...
t_GenericNestedPredicate = Union[
    GenericNestedAnyOf[_t_SpecifiedType],
    GenericNestedAllOf[_t_SpecifiedType],
    GenericNestedNoneOf[_t_SpecifiedType],
...
if not TYPE_CHECKING:
    ...
    # Nested predicates
    NestedAllOf.model_rebuild()
    NestedAnyOf.model_rebuild()
    NestedNoneOf.model_rebuild()
