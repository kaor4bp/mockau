...
class VoidPredicate(BaseLogicalPredicate):
    """Predicate that never matches any value (empty set).

    Always returns False for verification and is represented by Z3 BoolVal(False).

    .. Generated by Claude Sonnet 4 (Anthropic)
    """

    type_of: Literal['$-minow-void'] = '$-minow-void'
    ...
    def predicate_types(self):
        ...
        :return: Set containing Any type
...
class AnyPredicate(BaseScalarPredicate):
    ...
    Always returns True for verification and is represented by Z3 BoolVal(True).

    .. Generated by Claude Sonnet 4 (Anthropic)
    """

    type_of: Literal['$-minow-any'] = '$-minow-any'
    ...
    def to_z3(self, ctx: VariableContext):
        ...
        return z3.Not(ctx.json_type_variable.is_undefined())


class NotPredicate(BaseLogicalPredicate, ParityPredicateMixin):
    type_of: Literal['$-minow-not'] = '$-minow-not'
...
class BaseLogicalCollectionPredicate(BaseLogicalPredicate, ParityPredicateMixin, ABC):
    """Base class for logical predicates that operate on collections of predicates.
    ...
    def get_all_predicates(self):
        """Get all predicates in this logical predicate tree.
...
class AndPredicate(BaseLogicalCollectionPredicate):
    """Predicate for logical AND operation on multiple predicates.

    .. Generated by Claude Sonnet 4 (Anthropic)
    """

    type_of: Literal['$-minow-and'] = '$-minow-and'
...
class OrPredicate(BaseLogicalCollectionPredicate):
    """Predicate for logical OR operation on multiple predicates.

    .. Generated by Claude Sonnet 4 (Anthropic)
    """

    type_of: Literal['$-minow-or'] = '$-minow-or'
