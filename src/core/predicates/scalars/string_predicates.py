...
class StringEqualTo(BaseStringPredicate):
    ...
    type_of: Literal['$-minow-str-eq'] = '$-minow-str-eq'
    value: str
...
class StringNotEqualTo(BaseStringPredicate):
    ...
    type_of: Literal['$-minow-str-neq'] = '$-minow-str-neq'
    value: str
    ignore_case: bool = False
...
class StringPattern(BaseStringPredicate):
    ...
    type_of: Literal['$-minow-str-re'] = '$-minow-str-re'
    pattern: str
    ignore_case: bool = False
...
class StringNotPattern(BaseStringPredicate):
    ...
    type_of: Literal['$-minow-str-not-re'] = '$-minow-str-not-re'
    pattern: str
    ignore_case: bool = False
...
class StringContains(BaseStringPredicate):
    ...
    type_of: Literal['$-minow-str-contains'] = '$-minow-str-contains'
    value: str
    ignore_case: bool = False
...
class StringNotContains(StringContains):
    type_of: Literal['$-minow-str-not-contains'] = '$-minow-str-not-contains'
    value: str
...
class StringInList(BaseStringListPredicate):
    ...
    type_of: Literal['$-minow-str-in-list'] = '$-minow-str-in-list'
...
class StringNotInList(BaseStringListPredicate):
    ...
    type_of: Literal['$-minow-str-not-in-list'] = '$-minow-str-not-in-list'
...
class StringConcatEqualTo(BaseStringPredicate):
    type_of: Literal['$-minow-str-concat-eq'] = '$-minow-str-concat-eq'
...
class StringConcatNotEqualTo(BaseStringPredicate):
    type_of: Literal['$-minow-str-concat-neq'] = '$-minow-str-concat-neq'
    values: list['t_StringOrIntegerPredicateType']
