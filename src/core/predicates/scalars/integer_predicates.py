...
class IntegerEqualTo(BaseIntegerPredicate):
    ...
    type_of: Literal['$-minow-integer-eq'] = '$-minow-integer-eq'
    value: int
...
class IntegerNotEqualTo(BaseIntegerPredicate):
    type_of: Literal['$-minow-integer-neq'] = '$-minow-integer-neq'
    value: int
...
class IntegerGreaterThan(BaseIntegerPredicate):
    ...
    type_of: Literal['$-minow-integer-gt'] = '$-minow-integer-gt'
    value: int
...
class IntegerGreaterOrEqualThan(BaseIntegerPredicate):
    ...
    type_of: Literal['$-minow-integer-gte'] = '$-minow-integer-gte'
    value: int
...
class IntegerLessThan(BaseIntegerPredicate):
    ...
    type_of: Literal['$-minow-integer-lt'] = '$-minow-integer-lt'
    value: int
...
class IntegerLessOrEqualThan(BaseIntegerPredicate):
    ...
    type_of: Literal['$-minow-integer-lte'] = '$-minow-integer-lte'
    value: int
